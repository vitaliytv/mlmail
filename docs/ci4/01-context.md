...
Застосунок MLMaiL не має веб-версії — Tauri не підтримує web як платформу розгортання; Vue-фронтенд застосунку MLMaiL розгортається лише в межах Tauri WebView.
