...
- При 31 чернетці в пулі дефолтний батч (30) перевищив output-token ліміт Claude Sonnet — потребує зменшення батчу (див. `normalize-decisions-batch-sonnet.md`)
...
- Додатковий час виконання: кожен батч проходить двічі (dry + real)
